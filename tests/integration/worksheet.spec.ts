...
describe('Worksheet', () => {
  describe('Values', () => {
    ...
    it('adds rows with style option', () => {
      ...
      expect(ws.getCell('A3').font).not.toEqual(
        testutils.styles.fonts.comicSansUdB16
      );
      expect(ws.getCell('A4').font).not.toEqual(
        testutils.styles.fonts.comicSansUdB16
      );
    });
    ...
    it('inserts rows with style option', () => {
      ...
      expect(ws.getCell('A1').font).not.toEqual(
        testutils.styles.fonts.comicSansUdB16
      );
      expect(ws.getCell('A2').font).not.toEqual(
        testutils.styles.fonts.comicSansUdB16
      );
      expect(ws.getCell('A3').font).not.toEqual(
        testutils.styles.fonts.comicSansUdB16
      ...
      for (let i = 7; i <= 8; i++) {
        expect(ws.getCell(`A${i}`).font).not.toEqual(
          testutils.styles.fonts.comicSansUdB16
        );
      }
      for (let i = 10; i <= 12; i++) {
    ...
    it('should style of the inserted row with inherited style be mutable', () => {
      ...
      expect(ws.getRow(2).font).not.toEqual(
        testutils.styles.fonts.comicSansUdB16
      );
      expect(ws.getRow(3).font).not.toEqual(
        testutils.styles.fonts.comicSansUdB16
      );
      expect(ws.getCell('A2').font).not.toEqual(
        testutils.styles.fonts.comicSansUdB16
